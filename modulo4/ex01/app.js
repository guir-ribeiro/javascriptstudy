...
const arrowConvertString = value => String(value);

// console.log(5)
// console.log(arrowConvertString(5))
...
// console.log(lengthString('Guilherme'))
...
const lowerCaseFunc = string => string.toLowerCase()

// console.log(lowerCaseFunc("CHOCOTONE E OVO DE PÁSCOA JUNTOS NO MERCADO EM PLENO FEVEREIRO"))
...
const getItemString = (caracter, string) => string.indexOf(caracter);

// console.log(getItemString('r', 'guilherme'))
...
console.log(getLikesMessage(['Guilherme', 'Flavio', 'Roger', 'Marcos', 'Mateus']))