...
//         stringAmount++;
//         arraysValues.push(randomValues[i])
        
//     }else if(typeOfItem === 'boolean'){
//         booleonAmount++;
//     }
...
// console.log(`As primeiras 4 strings são: ${arraysValues} `);
// console.log(`Até que as primeiras 4 strings fossem iteradas, ${booleonAmount} booleans foram iterados`);
// console.log(`O array foi iterado por ${totalInteration} vezes. `);
