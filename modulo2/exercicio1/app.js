...
const my3FavoriteTVShows = ['The BigBang Theory', 'Grays Anatomy', 'Supernatural'];
...
// console.log(`A string que a "typeSentence" armazena tem mais de ${numeroCaracteres} caracteres? ${typeSentence.length > numeroCaracteres}.`)
