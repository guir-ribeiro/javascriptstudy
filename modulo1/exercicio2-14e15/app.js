...
const string= 'Grandes podres trazem grandes reponsabilidades' ;
// console.log(string);
...
const realBestMovie = bestMovie.slice(0 , (bestMovie.indexOf(':') + 2)) + 'Moonlight'

// console.log(realBestMovie)

const realBestMovie2 = bestMovie.replace('La la land', 'Moonlight');
// console.log(realBestMovie2)
